    ...
    return (
        <div className='position-relative d-flex justify-content-center align-items-center' style={{ '--porcentaje': valor }}>
            <svg width='42' height='42'>
                <circle className='circulogrande' r='21' cx='50%' cy='50%' pathLength='100' />
                <circle className='circulo' r='15' cx='50%' cy='50%' pathLength='100' />
                <circle className='circulo' r='15' cx='50%' cy='50%' pathLength='100' />
            </svg>
            <span className='text-light position-absolute fw-bold' style={{ fontSize: '.6rem' }} >{valor}%</span>
        </div>
